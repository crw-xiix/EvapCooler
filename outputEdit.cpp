...
void outputEditSite(void (*printFunction)(const char *) ) {
	...
	printFunction("            $.getJSON(\"/config.json\", function (data) {");
	...
	printFunction("            st += \"Password=\" + $(\"#DPassword\").val() + \",\\n\";");
	...
	printFunction("            st += \",\\n\";");
	printFunction("");
	printFunction("            st += \"FanMode=\" + $(\"#DFanMode\").val() + \",\\n\";");
	printFunction("            st += \"PumpMode=\" + $(\"#DPumpMode\").val() + \",\\n\";");
	printFunction("            st += \"VacationMode=\" + $(\"#DVacationMode\").val() + \",\\n\";");
	printFunction("            st += \"DayTemp=\" + $(\"#DDayTemp\").val() + \",\\n\";");
	printFunction("            st += \"NightMax=\" + $(\"#DNightMax\").val() + \",\\n\";");
	printFunction("            st += \"NightMin=\" + $(\"#DNightMin\").val() + \",\\n\";");
	printFunction("");
	printFunction("");
	...
	printFunction("<h1>{%3}</h1>");
	printFunction("            <h2>Edit Setup</h2>");
	...
	printFunction("                    <div class=\"col\">");
	printFunction("                        <button type=\"button\" class=\"btn btn-success\" id=\"bSavePromt\" data-toggle=\"modal\" data-target=\"#myModal\">Save</button>");
	...
	printFunction("                                <p>A password is required to update the configuration settings on this device.  Please call (800) FUC-KYOU ext:ASSHOLE to get your password for this device.</p>");
	printFunction("                                <label for=\"DPassword\">EEPROM write password:</label>");
	...
	printFunction("                                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\" id=\"bSave\">Save</button>");
	printFunction("                            </div>");
	printFunction("                        </div>");
	printFunction("");
	printFunction("                    </div>");
